...
<img style="float: right; width:100%; border:0px solid; margin-right: 10px" src="images/IMUTag.jpeg">
...
I started my PhD in the fall of 2019 at Harvard University in the [Department of Organismic and Evolutionary Biology](https://oeb.harvard.edu/). I am a member of Dr. George Lauders Biomechanics and Hydrodynamics lab. I am broadly interested in fish behavior and I would like to begin to understand the kinematics of fishes in their natural environment. I am currently building a multiaccelerometer datalogger allowing for who body kimatics from fish in the wild.


<img style="float: right; width:100%; border:0px solid; margin-right: 10px" src="images/SMB_Tagging.jpg">
...
<img style="float: right; width:100%; border:0px solid; margin-right: 10px" src="images/intertidal.jpg">
